...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_rating'])) {
    ...
    // Insert rating into database if no errors
    if (empty($errors)) {
        $sql = "INSERT INTO ratings (car_id, email, rating, rating_date) 
                VALUES ('" . $_SESSION['car_id'] . "', '$email', '$rating', '$rating_date')";
        
        if ($conn->query($sql) === TRUE) {
            echo "<script>alert('Rating added successfully');</script>";
        } else {
            echo "<script>alert('Error adding rating: " . $conn->error . "');</script>";
        }
    }
}
...
<body>
    <a href="manage_ratings.php" class="back-link"><-Back to Manage Ratings</a>
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <input type="submit" name="add_rating" value="Add Rating">
        </form>
    </div>
